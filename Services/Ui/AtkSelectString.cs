...
{
    public unsafe class AtkSelectString : AtkOverlay
    {
        ...
        public AtkSelectString(IGameGui gameGui, IPluginLog pluginLog, IGameUiManager gameUiManager) : base(gameGui)
        {
        ...
        public override WindowName WindowName { get; set; } = WindowName.SelectString;
